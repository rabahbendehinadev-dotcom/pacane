...
import {
  ...
  CheckCheck, Package, RotateCcw, CreditCard, Factory, TrendingDown, X,
  ChevronRight,
} from "lucide-react";
...
export function NotificationsDrawer({ open, onClose }: NotificationsDrawerProps) {
  ...
  const { data: alerts = [], isLoading, refetch } = useQuery<EAlert[]>({
  ...
  const readMutation = useMutation({
    ...
    onSuccess: () => { refetch(); qc.invalidateQueries({ queryKey: ["notifications-badge"] }); },
  });
